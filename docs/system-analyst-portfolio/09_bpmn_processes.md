...
8. Система рассчитывает общий километраж по введенным плечам маршрута и транспортную часть стоимости.
...
flowchart TD
    ...
    L --> M["Рассчитать километраж по введенным плечам и стоимость километража"]
    M --> N{"Нужно еще ТС?"}
    N -- "Да" --> J
...
| 7 | Система | Считает километраж по введенным плечам | Обновляется стоимость |
