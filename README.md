...
Веб-приложение, разработанное в рамках выпускной квалификационной работы по автоматизации деятельности менеджера компании по грузоперевозкам.
...
- назначение одного или нескольких ТС и водителей на заявку;
- контроль статусов заявки;
- архивирование заявок;
- расчет стоимости по типу груза и километражу;
- отчетность по заявкам, перевозкам и стоимости;
